use {crate::foxtrot::movement::general_movement::Model,
     bevy::prelude::*,
...
impl Default for AnimationEntityLink {
  fn default() -> Self { Self(Entity::from_raw(0)) }
}

pub(crate) fn link_animations(player_query: Query<Entity, Added<AnimationPlayer>>,
...
fn get_top_parent(curr_entity: Entity, parent_query: &Query<&Parent>) -> Entity {
  parent_query.iter_ancestors(curr_entity)
              .last()
