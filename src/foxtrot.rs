...
#[cfg(feature = "dev")] pub(crate) mod dev;
...
#[cfg(feature = "dev")]
use crate::foxtrot::dev::dev_plugin;
#[cfg(not(target_arch = "wasm32"))]
use crate::foxtrot::particles::particle_plugin;
use {crate::foxtrot::{bevy_config::bevy_config_plugin,
                      file_system_interaction::file_system_interaction_plugin,
                      ingame_menu::ingame_menu_plugin,
                      level_instantiation::level_instantiation_plugin, menu::menu_plugin,
                      movement::movement_plugin, player_control::player_control_plugin,
                      shader::shader_plugin, world_interaction::world_interaction_plugin},
     bevy::prelude::*,
