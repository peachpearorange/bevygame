...
fn spawn_spaceship(commands: &mut Commands) {
  commands.spawn_bundle(SpriteBundle { sprite: Sprite { color: Color::rgb(1.0, 1.0,
                                                                          1.0),
                                                        ..default() },
                                       ..default() });
}
...
fn spawn_asteroid(commands: &mut Commands, size: f32) {
  commands.spawn_bundle(SpriteBundle { sprite: Sprite { color: Color::rgb(0.5, 0.5,
                                                                          0.5),
                                                        size,
                                                        ..default() },
                                       ..default() });
...
//   commands.spawn_bundle(SpriteBundle { sprite: Sprite { color: Color::rgb(0.2, 0.4,
//                                                                           0.6),
//                                                         size: radius * 2.0,
//                                                         ..default() } });
// }
...
fn space_physics(time: Res<Time>,
                 mut query: Query<(&mut Transform, &mut Velocity), With<SpaceObject>>) {
