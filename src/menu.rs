// loading::FontAssets,
use {crate::foxtrot::GameState, bevy::prelude::*, bevy_fn_plugin::bevy_plugin};
...
// fn setup_menu(mut commands: Commands, font_assets: Res<FontAssets>, button_colors: Res<ButtonColors>) {
//   commands.spawn(Camera2dBundle::default());
//   commands.spawn(ButtonBundle { style: Style { size: Size::new(Val::Px(120.0), Val::Px(50.0)),
...
//             parent.spawn(TextBundle::from_section("Play", TextStyle { font: font_assets.fira_sans
//                                                                                        .clone(),
//                                                                       font_size: 40.0,
